        ...
        public void ConfigureLogger()
        {
            try
            {
                ...
                var fileTarget = new FileTarget("fileTarget")
                {
                    ...
                    Layout = "${longdate} | ${uppercase:${level}} | ${logger} | ${callsite} | ${message} ${exception:format=ToString}"
                };
        ...
        public void ClearOldLogs()
        {
            ...
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    {
                        fileInfo.Delete();
                        Console.WriteLine($"Удаление старого лога: {fileInfo.Name} ({fileInfo.Length} байт) Последнее изменение: {fileInfo.LastWriteTime}");
                    }
                }
            }
            catch (Exception ex)
